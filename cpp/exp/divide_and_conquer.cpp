...
namespace pldi17{
    Task* sumBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "sum", sum_semantics, defaultExampleConfig());
    }
    ...
    Task* minBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "min", min_semantics, defaultExampleConfig());
    }
    ...
    Task* maxBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "max", max_semantics, defaultExampleConfig());
    }
    ...
    Task* averageBuilder() {
        ...
        c.int_min = 0;
        c.int_max = 20;
        return benchmark::defaultBuilder("tree", "average", average_semantics, c, {},
                {div_semantics, plus});
    }
    ...
    Task* lengthBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "length", length_semantics, defaultExampleConfig());
    }
    ...
    Task* secondMinBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "2nd-min", second_min_semantics, defaultExampleConfig());
    }
    ...
    Task* mpsBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "mps", mps_semantics, defaultExampleConfig());
    }
    ...
    Task* mtsBuilder() {
       ...
       return benchmark::defaultBuilder("tree", "mts", mts_semantics, defaultExampleConfig());
    }
    ...
    Task* mssBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "mss", mss_semantics, defaultExampleConfig());
    }
    ...
    Task* mpsPosBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "mps_p", mps_pos_semantics, defaultExampleConfig());
    }
    ...
    Task* mtsPosBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "mts_p", mts_pos_semantics, defaultExampleConfig());
    }
    ...
    Task* isSortedBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "is_sorted", is_sorted_semantics, defaultExampleConfig());
    }
    ...
    Task* atoiBuilder() {
        ...
        c.int_max = 9;
        c.max_length = 4;
        return benchmark::defaultBuilder("tree", "atoi", atoi_semantics, c, {}, {pow10_info, semantics::getSemanticsFromName("*")});
    }
    ...
    Task* dropWhileBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "dropwhlie", drop_while_semantics, c);
    }
    ...
    Task* balancedBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "balanced", balanced_semantics, c);
    }
    ...
    Task* zeroStartOneStarBuilder() {
        ...
        auto c = defaultExampleConfig();
        c.int_min = 0; c.int_max = 1;
        return benchmark::defaultBuilder("tree", "0*1*", zero_star_one_star_semantics, c);
    }
    ...
    Task* cntOnesBuilder() {
        ...
        auto c = defaultExampleConfig();
        c.int_min = 0; c.int_max = 1;
        return benchmark::defaultBuilder("tree", "cnt_1s", cnt_ones_semantics, c);
    }
    ...
    Task* lineSightBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "line_sight", line_sight_semantics, defaultExampleConfig());
    }
    ...
    Task* maxLenOnesBuilder() {
        ...
        auto c = defaultExampleConfig();
        c.int_min = 0; c.int_max = 1;
        return benchmark::defaultBuilder("tree", "max_len_1s", max_len_1s_semantics, c);
    }
    ...
    Task* zeroAfterOneBuilder() {
        ...
        auto c = defaultExampleConfig();
        c.int_min = 0; c.int_max = 1;
        return benchmark::defaultBuilder("tree", "0after1", zero_after_1_semantics, c);
    }
}
...
namespace pldi21 {
    Task* count10PlusBuilder() {
        ...
        c.int_min = 0;
        c.int_max = 1;
        return benchmark::defaultBuilder("tree", "count1(0+)", count_10plus_semantics, c);
    }
    ...
    Task* count10star2Builder() {
        ...
        auto r_list = regex_tool::extraSemanticsForReg({"0", "1", "2"}, 3, 50);
        auto c = defaultExampleConfig();
        c.int_min = 0;
        c.int_max = 5;
        return benchmark::defaultBuilder("tree", "count1(0*)2", count_10star2_semantics, c, r_list);
    }
    ...
    Task* count1star2star3starBuilder() {
        ...
        c.int_min = 1;
        c.int_max = 3;
        return benchmark::defaultBuilder("tree", "count1*2*3*", count_1star2star3star_semantics, c);
    }
    ...
    Task* maxSumBetweenOnesBuilder() {
        ...
        c.int_min = 0;
        c.int_max = 3;
        return benchmark::defaultBuilder("tree", "max_sum_between_ones", max_sum_between_ones_semantics, c, {prefix_till_one_semantics});
    }
    ...
    Task* maxDistanceBetweenZerosBuilder() {
        ...
        c.int_min = 0;
        c.int_max = 1;
        return benchmark::defaultBuilder("tree", "max_dist_between_zeros", max_distance_between_zeros_semantics, c);
    }
    ...
    Task* lisBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "lis", lis_semantics, defaultExampleConfig(), {ExtraSemantics({nt_int, bool_bif, nt_list})});
    }
    ...
    Task* largestPeakBuilder() {
        ...
        nt_list->rule_list.push_back(new Rule(new AnonymousSemantics(longest_prefix, {TLIST, TSEMANTICS}, TLIST, "longest_prefix"),
                                             {nt_list, bool_hf}));
        return benchmark::defaultBuilder("tree", "largest_peak", largest_peak_semantics, defaultExampleConfig(),
                                         {ExtraSemantics({bool_hf, nt_list})});
    }
    ...
    Task* longest1starBuilder() {
        ...
        c.int_min = 0;
        c.int_max = 1;
        return benchmark::defaultBuilder("tree", "longest1*", longest_1star_semantics, c);
    }
    ...
    Task* longest10star2Builder() {
        ...
        c.int_min = 0;
        c.int_max = 2;
        return benchmark::defaultBuilder("tree", "longest1(0*)2", longest_10star2_semantics, c, r_list);
    }
    ...
    Task* longestEven0starBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "longest(00)*", longest_even_0star_semantics, c, {}, {is_even_info});
    }
    ...
    Task* longestOdd10starBuilder() {
        ...
        auto ex_list = regex_tool::extraSemanticsForReg({"0*", "1", "(0+1)*"}, 3, 50);
        auto is_even = [](DataList&& inp, GlobalInfo* global_info) -> Data {
            return inp[0].getInt() % 2;
        };
        ...
        c.max_length = 15;
        c.init_size *= 10;
        return benchmark::defaultBuilder("tree", "longest_odd_(10*)", longest_odd_10star, c,
...
namespace extra {
    Task* thirdMinBuilder() {
        ...
        return benchmark::defaultBuilder("tree", "3rd-min", third_min_semantics, defaultExampleConfig());
    }
    ...
    Task* mppBuilder() {
        ...
        c.int_min = -3;
        c.int_max = 3;
        return benchmark::defaultBuilder("tree", "mpp", mpp_semantics, c, {}, {semantics::getSemanticsFromName("*")});
    }
    ...
    Task* mtpBuilder() {
        ...
        c.int_min = -3;
        c.int_max = 3;
        return benchmark::defaultBuilder("tree", "mtp", mtp_semantics, c, {}, {semantics::getSemanticsFromName("*")});
    }
    ...
    Task* mspBuilder() {
        ...
        c.int_min = -3;
        c.int_max = 3;
        return benchmark::defaultBuilder("tree", "msp", msp_semantics, c, {}, {semantics::getSemanticsFromName("*")});
    }
    ...
    Task* max1sPBuilder() {
        ...
        c.int_min = 0;
        c.int_max = 1;
        return benchmark::defaultBuilder("tree", "max_1s_p", max_1s_p_semantics, c,
